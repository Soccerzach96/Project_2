...
def grab_headlines():
    ...
    total_headlines = []
    for li in most_read.find('div', {'class':"item-list"}).findAll('li'):
    	total_headlines.append(li.a.text.replace("\n", " ").strip())
...
def get_umsi_data():
	...
	while base_url != 'https://www.si.umich.edu/directory?field_person_firstname_value=&field_person_lastname_value=&rid=All&page=13':
		...
		directory_name = d.find_all('div', {'class':"field-name-title"})
		directory_title = d.find_all('div', {'class':"field-type-text"})
		for person in directory_name:
			name_list.append(person.h2.text)
		for person in directory_title:
			title_list.append(person.text)
		count += 1
	...
	# d = soup.find_all('div', {'class':"view-content"})[0]
	# for person in d:
	# 	name = person.find('div', {'class':"field-name-title"})
	# 	print(person)
	# 	print(name)
	# 	print("!!!!!!")
		# print(person.find('div', {'class':"field-type-text"}))
		# description = d.find('div', {'class':"field-type-text"})
		# umsi_titles[name] = description
		# directory = d.find_all('div', {'class':"field-name-title"})
		# for person in directory:
		# 	print(person.h2.text)
		# count += 1
		# base_url = 'https://www.si.umich.edu/directory?field_person_firstname_value=&field_person_lastname_value=&rid=All&page=' + str(count)
		# print(base_url)
	...
	# 	d = soup.find_all('div', {'class':"view-content"})[0]
	# 	for person in d:
	# 		directory_name = d.find('div', {'class':"field-name-title"}).text
	# 		directory_title = d.find('div', {'class':"field-type-text"}).text
	# 		print(directory_name + ": " + directory_title)
	# 	# for person in directory_name:
	# 	# 	print(person.h2.text)
	# 	# for person in directory_title:
	# 	# 	print(person.text)
	...
	# 			# p = person.find_all('div', {'class': "field-name-title"}).find('h2')
	# 			print(p)
	# 	count += 1
	# 	base_url = 'https://www.si.umich.edu/directory?field_person_firstname_value=&field_person_lastname_value=&rid=All&page=' + str(count)
	# 	print(base_url)
